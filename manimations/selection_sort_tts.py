...
# #             self.play(Create(squares), Write(labels), Create(arrow))
# #             self.wait(1)
...
# #                 self.play(squares[min_idx].animate.set_color(BLUE))

# #             for j in range(i + 1, n):
# #                 # Highlight comparison
# #                 self.play(squares[j].animate.set_color(RED), squares[min_idx].animate.set_color(BLUE))
# #                 self.wait(0.2)
# #                 self.play(squares[j].animate.set_color(WHITE), squares[min_idx].animate.set_color(BLUE))
...
#         algo_text = """Selection Sort Algorithm:
#         for i in range(n-1):
#             min_idx = i
#             for j in range(i+1, n):
#                 if arr[j] < arr[min_idx]:
#                     min_idx = j
#             arr[i], arr[min_idx] = arr[min_idx], arr[i]"""
#         algo_display = Text(algo_text, font_size=28).to_edge(DOWN)
#         self.play(Write(algo_display))
